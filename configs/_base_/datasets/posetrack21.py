dataset_info = dict(
    ...
    paper_info=dict(
        author='Andreas Doering and Di Chen and '
        'Shanshan Zhang and Bernt Schiele and Juergen Gall',
        title='PoseTrack21: a Dataset for Person Search, '
        'Multi-Object Tracking and Multi-Person Pose Tracking',
        container='Proceedings of the IEEE Conference on '
        'Computer Vision and Pattern Recognition',
        year='2021',
        homepage='https://github.com/anDoer/PoseTrack21',
    ),
    keypoint_info={
        0:
