_base_ = [
    ...
    '../../../../_base_/datasets/posetrack21.py'
]
load_from = 'https://download.openmmlab.com/mmpose/top_down/hrformer/hrformer_base_coco_384x288-ecf0758d_20220316.pth'  # noqa: E501
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/annotations/posetrack21_train.json',
    ...
    val=dict(
        type='TopDownPoseTrack18Dataset',
        ann_file=f'{data_root}/annotations/posetrack21_val.json',
        img_prefix=f'{data_root}/',
        data_cfg=data_cfg,
